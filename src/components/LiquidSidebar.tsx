...
export const LiquidSidebar = ({ 
  ...
  return (
    <div
      className={`liquid-sidebar ${expanded ? 'expanded' : ''}`}
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="sidebar-text mt-4 p-3 glass rounded-lg">
      ...
      <div className="px-4 flex-1">
        <div className="sidebar-text px-3 py-2 mb-2">
          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full p-4 rounded-xl transition-all duration-300 flex items-center ${
              ...
              >
                ...
                <div className={`sidebar-text flex-1 text-left ${expanded ? 'block' : 'hidden'}`}>
                ...
                {expanded && isActive && (
                  <Zap className="sidebar-text w-4 h-4 text-primary animate-pulse" />
                )}
              </button>
            );
          })}
      ...
      <div className="p-4">
        {expanded ? (
          <div className="sidebar-text glass rounded-xl p-4 space-y-3">
            <div className="flex items-center space-x-3">
