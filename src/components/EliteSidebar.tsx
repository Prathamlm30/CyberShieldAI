...
  return (
    // The 'glass' class was removed from this line to make the main sidebar background transparent
    <Sidebar className="w-80 border-r border-glass-border">
...
                    }`}
                  >
          _            <div className="flex items-center space-x-4">
